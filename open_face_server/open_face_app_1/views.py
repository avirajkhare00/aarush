...
def recognize_person(request):
    ...
    process = subprocess.Popen(["/root/openface/demos/classifier.py infer /root/openface/generated-embeddings/classifier.pkl " + "open_face_app_1/static/open_tickets/" + ticket_number + '.jpg'], stdout=subprocess.PIPE)
